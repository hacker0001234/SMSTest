...
export default function MainPage() {
    ...
    const changeCode = (event, newValue) => {
        setCountry("+" + newValue.phone)
    }
    ...
    return (
        <div className={"form-login-phone"}>
            <Autocomplete
                onChange={changeCode}
                ...
                renderInput={(params) => {
                    const selectedCountry = countries.find(
                        (c) => `+${c.phone}` === params.inputProps.value
                    );
            ...
            <TextField id="standard-basic" label="Enter phone(without country code)" variant="standard"
